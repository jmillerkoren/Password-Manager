...
;(function (root, factory, undef) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(0), __webpack_require__(7), __webpack_require__(8), __webpack_require__(1), __webpack_require__(11));
	}
	else {}
}(this, function (CryptoJS) {
...
/* harmony import */ var crypto_js_aes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
/* harmony import */ var crypto_js_enc_utf8__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
    ...
    chrome.storage.local.get(['access_token', 'vault_key'], function(result) {
        ...
        fetch(`http://localhost:8000/api/v1/vault/vault_item/?url=${encodeURIComponent(request.url)}`,
            ...
            .then(data => {
                data.password = decryptPassword(data.password, result['vault_key']).toString(crypto_js_enc_utf8__WEBPACK_IMPORTED_MODULE_1___default.a);
                sendResponse({data});
            })
    });
    return true;
...
function decryptPassword(encryptedPass, key) {
    let password = crypto_js_aes__WEBPACK_IMPORTED_MODULE_0___default.a.decrypt(encryptedPass, key);
    return password;
}
